...
[MDN browser compatibility data: Taking the guesswork out of web compatibility – Mozilla Hacks – the Web developer blog](https://hacks.mozilla.org/2018/02/mdn-browser-compatibility-data/ "MDN browser compatibility data: Taking the guesswork out of web compatibility – Mozilla Hacks – the Web developer blog")という記事ではMDN表示しているブラウザの互換性データについて書かれています。
